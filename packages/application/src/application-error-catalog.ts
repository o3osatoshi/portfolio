...
export const applicationErrorCodes = {
  ...
  CREATE_TRANSACTION_FAILED: "APP_CREATE_TRANSACTION_FAILED",
  CREATE_TRANSACTION_REQUEST_INVALID: "APP_CREATE_TRANSACTION_REQUEST_INVALID",
  DELETE_TRANSACTION_FAILED: "APP_DELETE_TRANSACTION_FAILED",
  DELETE_TRANSACTION_REQUEST_INVALID: "APP_DELETE_TRANSACTION_REQUEST_INVALID",
  FORBIDDEN: "APP_FORBIDDEN",
  GET_FX_QUOTE_FAILED: "APP_GET_FX_QUOTE_FAILED",
  GET_FX_QUOTE_REQUEST_INVALID: "APP_GET_FX_QUOTE_REQUEST_INVALID",
  GET_TRANSACTIONS_FAILED: "APP_GET_TRANSACTIONS_FAILED",
  GET_TRANSACTIONS_REQUEST_INVALID: "APP_GET_TRANSACTIONS_REQUEST_INVALID",
  HEAVY_PROCESS_CACHED_FAILED: "APP_HEAVY_PROCESS_CACHED_FAILED",
  HEAVY_PROCESS_FAILED: "APP_HEAVY_PROCESS_FAILED",
  ...
  STORE_PING_FAILED: "APP_STORE_PING_FAILED",
  ...
  UPDATE_TRANSACTION_FAILED: "APP_UPDATE_TRANSACTION_FAILED",
  UPDATE_TRANSACTION_REQUEST_INVALID: "APP_UPDATE_TRANSACTION_REQUEST_INVALID",
