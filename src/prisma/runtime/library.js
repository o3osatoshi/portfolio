...
function Ds(e) {
  ...
  for (let n in e.parsed) {
    let i = Object.hasOwn(r, n) ? r[n] : e.parsed[n];
    e.parsed[n] = t(i);
  }
...
m.precision = m.sd = function (e) {
  ...
  return (
    this.d
      ? ((r = Qs(this.d)), e && this.e + 1 > r && (r = this.e + 1))
      : (r = NaN),
    r
  );
};
...
function Ys(e) {
  ...
  function i(o) {
    ...
    if (l === "bigint")
      return (
        o < 0 ? ((o = -o), (this.s = -1)) : (this.s = 1), ln(this, o.toString())
      );
    throw Error(He + o);
  }
  if (
...
var md = (e) => e,
  ...
  v = {
      ...
      clone: function e(r, t) {
        ...
        switch (((t = t || {}), o)) {
          case "Object":
            ...
            (n = {}), (t[i] = n);
            for (let s in r) Object.hasOwn(r, s) && (n[s] = e(r[s], t));
            return n;
          case "Array":
            return (
              (i = v.util.objId(r)),
      ...
      insertBefore: (e, r, t, n) => {
        ...
        for (let a in i)
          if (Object.hasOwn(i, a)) {
            if (a == r) for (let l in t) Object.hasOwn(t, l) && (o[l] = t[l]);
    ...
    matchGrammar: (e, r, t, n, i, o, s) => {
      for (let h in t) {
        if (!Object.hasOwn(t, h) || !t[h]) continue;
        if (h == s) return;
        let I = t[h];
