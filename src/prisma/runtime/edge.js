...
C.minus = C.sub = function (e) {
  ...
  if (
    ((r = X(e.e / O)), (g = X(this.e / O)), (f = f.slice()), (o = g - r), o)
  ) {
    for (
      h = o < 0,
        h
...
C.plus = C.add = function (e) {
  ...
  if (
    ((o = X(this.e / O)), (n = X(e.e / O)), (f = f.slice()), (i = o - n), i)
  ) {
    for (
      i < 0
        ? ((r = f), (i = -i), (s = g.length))
...
C.precision = C.sd = function (e) {
  ...
  return (
    this.d
      ? ((t = go(this.d)), e && this.e + 1 > t && (t = this.e + 1))
      : (t = NaN),
    t
  );
};
...
function bo(e) {
  ...
  function i(o) {
    ...
    if (l === "bigint")
      return (
        o < 0 ? ((o = -o), (this.s = -1)) : (this.s = 1), hr(this, o.toString())
      );
    throw Error(Ie + o);
  }
  if (
