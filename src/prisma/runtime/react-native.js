    ...
    if (
      ...
      if (((r = r.slice(s - 3, s + 1)), r == "9999" || (!i && r == "4999"))) {
        ...
        (!+r || (!+r.slice(1) && r.charAt(0) == "5")) &&
          (O(n, e + 1, 1), (t = !n.times(n).times(n).eq(this)));
        break;
      }
...
S.minus = S.sub = function (e) {
  ...
  if (
    ((r = te(e.e / F)), (g = te(this.e / F)), (u = u.slice()), (o = g - r), o)
  ) {
    for (
      h = o < 0,
        h
...
S.plus = S.add = function (e) {
  ...
  if (
    ((o = te(this.e / F)), (n = te(e.e / F)), (u = u.slice()), (i = o - n), i)
  ) {
    for (
      i < 0
        ? ((r = u), (i = -i), (s = g.length))
...
S.precision = S.sd = function (e) {
  ...
  return (
    this.d
      ? ((t = uo(this.d)), e && this.e + 1 > t && (t = this.e + 1))
      : (t = NaN),
    t
  );
};
...
function go(e) {
  ...
  function i(o) {
    ...
    if (l === "bigint")
      return (
        o < 0 ? ((o = -o), (this.s = -1)) : (this.s = 1), ur(this, o.toString())
      );
    throw Error(qe + o);
  }
  if (
      ...
      clone: function e(t, r) {
        ...
        switch (((r = r || {}), o)) {
          case "Object":
            ...
            (n = {}), (r[i] = n);
            for (let s in t) Object.hasOwn(t, s) && (n[s] = e(t[s], r));
            return n;
          case "Array":
            return (
              (i = N.util.objId(t)),
      ...
      insertBefore: (e, t, r, n) => {
        ...
        for (let a in i)
          if (Object.hasOwn(i, a)) {
            if (a == t) for (let l in r) Object.hasOwn(r, l) && (o[l] = r[l]);
