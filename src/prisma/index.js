...
const config = {
  generator: {
    ...
    output: {
      value:
        "/Users/o3osatoshi/project/o3osatoshi/experiment/src/prisma",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
    ...
    previewFeatures: [],
    sourceFilePath:
      "/Users/o3osatoshi/project/o3osatoshi/experiment/prisma/schema.prisma",
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: "../../../../.env",
  ...
  inlineSchemaHash:
    "004fb44ec1b2e5c95f61e1c8df73b47a5da2fc8c0202800f526ddd23b92f7bde",
  copyEngine: true,
};
...
if (!fs.existsSync(path.join(__dirname, "schema.prisma"))) {
  const alternativePaths = ["src/prisma", "app/generated/prisma"];
...
path.join(
  process.cwd(),
  "src/prisma/libquery_engine-darwin-arm64.dylib.node",
);
// file annotations for bundling tools to include these files
