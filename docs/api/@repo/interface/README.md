...
[Documentation](../../README.md) / @repo/interface
...
- [EdgeAppType](type-aliases/EdgeAppType.md)
- [EdgeDeps](type-aliases/EdgeDeps.md)
- [InferResponseType](type-aliases/InferResponseType.md)
- [SuccessStatusCode](type-aliases/SuccessStatusCode.md)

## Functions

- [buildApp](functions/buildApp.md)
- [buildEdgeApp](functions/buildEdgeApp.md)
- [buildEdgeHandler](functions/buildEdgeHandler.md)
- [buildHandler](functions/buildHandler.md)
- [createEdgeRpcClient](functions/createEdgeRpcClient.md)
- [createExpressRequestHandler](functions/createExpressRequestHandler.md)
- [createRpcClient](functions/createRpcClient.md)
- [loggerMiddleware](functions/loggerMiddleware.md)
- [requestIdMiddleware](functions/requestIdMiddleware.md)
- [respond](functions/respond.md)
- [respondAsync](functions/respondAsync.md)
- [respondZodError](functions/respondZodError.md)
